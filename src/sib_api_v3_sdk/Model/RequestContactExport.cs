...
namespace sib_api_v3_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RequestContactExport :  IEquatable<RequestContactExport>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="contactFilter">Set the filter for the contacts to be exported. For example, {&#39;blacklisted&#39;:true} will export all the blacklisted contacts. (required).</param>
        /// <param name="notifyUrl">Webhook that will be called once the export process is finished.</param>
        public RequestContactExport(List<string> exportAttributes = default(List<string>), Object contactFilter = default(Object), string notifyUrl = default(string))
        {
            // to ensure "contactFilter" is required (not null)
            if (contactFilter == null)
            {
                throw new InvalidDataException("contactFilter is a required property for RequestContactExport and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Set the filter for the contacts to be exported. For example, {&#39;blacklisted&#39;:true} will export all the blacklisted contacts.</value>
