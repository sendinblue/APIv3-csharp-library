...
namespace sib_api_v3_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetList :  IEquatable<GetList>, IValidatableObject
    {
        /// <summary>
        ...
        public GetList(long? id = default(long?), string name = default(string), long? totalBlacklisted = default(long?), long? totalSubscribers = default(long?))
        {
            ...
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for GetList and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for GetList and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            {
                throw new InvalidDataException("totalBlacklisted is a required property for GetList and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("totalSubscribers is a required property for GetList and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as GetList);
        }

        /// <summary>
        /// Returns true if GetList instances are equal
        /// </summary>
        /// <param name="input">Instance of GetList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetList input)
        {
            if (input == null)
                return false;
