...
namespace sib_api_v3_sdk.Model
{
    ...
    public partial class CreateApiKeyResponse :  IEquatable<CreateApiKeyResponse>
    {
        ...
        /// </summary>
        /// <param name="status">Status of the API operation..</param>
        /// <param name="key">API Key.</param>
        public CreateApiKeyResponse(string status = default(string), string key = default(string))
        {
            this.Status = status;
            this.Key = key;
        }
        ...
        /// </summary>
        /// <value>Status of the API operation.</value>
