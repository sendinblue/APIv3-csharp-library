...
namespace sib_api_v3_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetSmsCampaign :  IEquatable<GetSmsCampaign>, IValidatableObject
    {
        /// <summary>
        ...
        public GetSmsCampaign(long? id = default(long?), string name = default(string), StatusEnum status = default(StatusEnum), string content = default(string), DateTime? scheduledAt = default(DateTime?), string sender = default(string), DateTime? createdAt = default(DateTime?), DateTime? modifiedAt = default(DateTime?), Object recipients = default(Object), Object statistics = default(Object))
        {
            ...
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for GetSmsCampaign and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for GetSmsCampaign and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for GetSmsCampaign and cannot be null");
            }
            else
            {
                this.Status = status;
            ...
            if (content == null)
            {
                throw new InvalidDataException("content is a required property for GetSmsCampaign and cannot be null");
            }
            else
            {
            ...
            if (sender == null)
            {
                throw new InvalidDataException("sender is a required property for GetSmsCampaign and cannot be null");
            }
            else
            {
                this.Sender = sender;
            ...
            if (createdAt == null)
            {
                throw new InvalidDataException("createdAt is a required property for GetSmsCampaign and cannot be null");
            }
            else
            {
            ...
            if (modifiedAt == null)
            {
                throw new InvalidDataException("modifiedAt is a required property for GetSmsCampaign and cannot be null");
            }
            else
            {
            ...
            if (recipients == null)
            {
                throw new InvalidDataException("recipients is a required property for GetSmsCampaign and cannot be null");
            }
            else
            {
            ...
            if (statistics == null)
            {
                throw new InvalidDataException("statistics is a required property for GetSmsCampaign and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as GetSmsCampaign);
        }

        /// <summary>
        /// Returns true if GetSmsCampaign instances are equal
        /// </summary>
        /// <param name="input">Instance of GetSmsCampaign to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetSmsCampaign input)
        {
            if (input == null)
                return false;
