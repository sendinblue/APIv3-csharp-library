...
namespace sib_api_v3_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetExtendedContactDetailsStatisticsUnsubscriptions :  IEquatable<GetExtendedContactDetailsStatisticsUnsubscriptions>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetExtendedContactDetailsStatisticsUnsubscriptions" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetExtendedContactDetailsStatisticsUnsubscriptions() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetExtendedContactDetailsStatisticsUnsubscriptions" /> class.
        /// </summary>
        /// <param name="userUnsubscription">Contact unsubscribe via unsubscription link in a campaign (required).</param>
        /// <param name="adminUnsubscription">Contact has been unsubscribed from the administrator (required).</param>
        public GetExtendedContactDetailsStatisticsUnsubscriptions(List<GetExtendedContactDetailsStatisticsUnsubscriptionsUserUnsubscription> userUnsubscription = default(List<GetExtendedContactDetailsStatisticsUnsubscriptionsUserUnsubscription>), List<GetExtendedContactDetailsStatisticsUnsubscriptionsAdminUnsubscription> adminUnsubscription = default(List<GetExtendedContactDetailsStatisticsUnsubscriptionsAdminUnsubscription>))
        {
            // to ensure "userUnsubscription" is required (not null)
            if (userUnsubscription == null)
            {
                throw new InvalidDataException("userUnsubscription is a required property for GetExtendedContactDetailsStatisticsUnsubscriptions and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("adminUnsubscription is a required property for GetExtendedContactDetailsStatisticsUnsubscriptions and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as GetExtendedContactDetailsStatisticsUnsubscriptions);
        }

        /// <summary>
        /// Returns true if GetExtendedContactDetailsStatisticsUnsubscriptions instances are equal
        /// </summary>
        /// <param name="input">Instance of GetExtendedContactDetailsStatisticsUnsubscriptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetExtendedContactDetailsStatisticsUnsubscriptions input)
        {
            if (input == null)
                return false;
