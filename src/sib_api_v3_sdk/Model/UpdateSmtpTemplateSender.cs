...
namespace sib_api_v3_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateSmtpTemplateSender :  IEquatable<UpdateSmtpTemplateSender>, IValidatableObject
    {
        /// <summary>
        ...
        public UpdateSmtpTemplateSender(string name = default(string), string email = default(string))
        {
            this.Name = name;
            this.Email = email;
        }
