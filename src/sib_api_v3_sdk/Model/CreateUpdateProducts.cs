...
namespace sib_api_v3_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateUpdateProducts :  IEquatable<CreateUpdateProducts>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateUpdateProducts" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateUpdateProducts() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateUpdateProducts" /> class.
        /// </summary>
        ...
        public CreateUpdateProducts(string id = default(string), string name = default(string), string url = default(string), string imageUrl = default(string), string sku = default(string), float? price = default(float?), List<string> categories = default(List<string>), string parentId = default(string), Dictionary<string, Object> metaInfo = default(Dictionary<string, Object>))
        {
            ...
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for CreateUpdateProducts and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for CreateUpdateProducts and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        {
            return this.Equals(input as CreateUpdateProducts);
        }

        /// <summary>
        /// Returns true if CreateUpdateProducts instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateUpdateProducts to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateUpdateProducts input)
        {
            if (input == null)
                return false;
