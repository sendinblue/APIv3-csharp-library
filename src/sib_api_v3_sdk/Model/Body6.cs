...
namespace sib_api_v3_sdk.Model
{
    ...
    public partial class Body6 :  IEquatable<Body6>
    {
        ...
        public Body6(string name = default(string), long? duration = default(long?), string taskTypeId = default(string), DateTime? date = default(DateTime?), string notes = default(string), bool? done = default(bool?), string assignToId = default(string), List<int?> contactsIds = default(List<int?>), List<string> dealsIds = default(List<string>), List<string> companiesIds = default(List<string>), TaskReminder reminder = default(TaskReminder))
        {
            ...
            if (taskTypeId == null)
            {
                throw new InvalidDataException("taskTypeId is a required property for Body6 and cannot be null");
            }
            else
            {
            ...
            if (date == null)
            {
                throw new InvalidDataException("date is a required property for Body6 and cannot be null");
            }
            else
            {
                this.Date = date;
