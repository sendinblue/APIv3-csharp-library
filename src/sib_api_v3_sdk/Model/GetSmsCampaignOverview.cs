...
namespace sib_api_v3_sdk.Model
{
    ...
    public partial class GetSmsCampaignOverview :  IEquatable<GetSmsCampaignOverview>
    {
        ...
        public GetSmsCampaignOverview(long? id = default(long?), string name = default(string), StatusEnum status = default(StatusEnum), string content = default(string), string scheduledAt = default(string), string sender = default(string), string createdAt = default(string), string modifiedAt = default(string))
        {
