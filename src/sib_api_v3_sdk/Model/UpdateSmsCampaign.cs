...
namespace sib_api_v3_sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateSmsCampaign :  IEquatable<UpdateSmsCampaign>, IValidatableObject
    {
        /// <summary>
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if(this.Sender != null && this.Sender.Length > 11)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Sender, length must be less than 11.", new [] { "Sender" });
            }
