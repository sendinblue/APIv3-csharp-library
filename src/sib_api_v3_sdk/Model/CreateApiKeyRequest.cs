...
namespace sib_api_v3_sdk.Model
{
    ...
    public partial class CreateApiKeyRequest :  IEquatable<CreateApiKeyRequest>
    {
        ...
        public CreateApiKeyRequest(long? id = default(long?), string name = default(string))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for CreateApiKeyRequest and cannot be null");
            }
            else
            {
                this.Id = id;
        ...
        /// Name of the API key
        /// </summary>
        /// <value>Name of the API key</value>
